...
MyGame.prototype.initialize = function () {
    ...
    this.mBall = new Hero(this.kMinionSprite);
    
    this.mHero.getXform().setPosition(20, 40);
    this.mBall.getXform().setPosition(50, 40);
    
    this.mHeroGoal = new SpriteRenderable(this.kWallTexture);
    this.mHeroGoal.setColor([1, 1, 1, 0]);
    this.mHeroGoal.getXform().setPosition(3, 40);
    this.mHeroGoal.getXform().setSize(5, 20);

    this.mEnemyGoal = new SpriteRenderable(this.kWallTexture);
    this.mEnemyGoal.setColor([1, 1, 1, 0]);
    this.mEnemyGoal.getXform().setPosition(97, 40);
    this.mEnemyGoal.getXform().setSize(5, 20);
    ...
    //this.mAllObjs.addToSet(this.mHeroGoal);
    var y = 70;
    var x = 10;
//    for (var i = 1; i<=5; i++) {
...
MyGame.prototype.draw = function () {
    ...
    this.mHeroGoal.draw(this.mCamera);
    this.mEnemyGoal.draw(this.mCamera);
};
...
//    }
    ...
    var ballBB = new BoundingBox(this.mBall.getXform().getPosition(), this.mBall.getXform().getWidth(), this.mBall.getXform().getHeight());
    var enemyGoalBB = new BoundingBox(this.mEnemyGoal.getXform().getPosition(), this.mEnemyGoal.getXform().getWidth(), this.mEnemyGoal.getXform().getHeight());
    var heroGoalBB = new BoundingBox(this.mHeroGoal.getXform().getPosition(), this.mHeroGoal.getXform().getWidth(), this.mHeroGoal.getXform().getHeight());
    
    if (ballBB.intersectsBound(enemyGoalBB))
    {
        this.heroScore++;
        this.mBall.getXform().setPosition(50, 40);
    ...
    if (ballBB.intersectsBound(heroGoalBB))
    {
        this.enemyScore++;
        this.mBall.getXform().setPosition(50, 40);
        this.mBall.getRigidBody().setVelocity(0, 0);
...
//           " V(" + gEngine.Physics.getHasMotion() + ")" + this.score;
        msg += "Player Score: " + this.heroScore + " Enemy Score: " + this.enemyScore;
